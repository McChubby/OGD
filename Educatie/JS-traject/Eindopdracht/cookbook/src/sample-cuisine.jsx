  ...
  cuisine1:{
    ...
    recipes:{
      recipe1:{
        ...
        steps:{
          step1:'Je warmt de boter en olijfolie in de pan op en fruit daarin de fijngehakte ui, selderij, wortel en het teentje knoflook.',
          step2:'Dan voeg je het gehakt, de spek en het laurierblaadje toe aan de pan',
          step3:'Roer alles goed dooreen, zodat het vlees niet aanbakt. Als het vlees gebakken is haal je het knoflookteentje eruit en doet er de tomaten, wijn,bouillon, tomatenpuree, peper, zout en veel kruiden bij.',
          step4:'Dit laat je dan op een heel zacht vuur enkele uren sudderen. Het mag gerust 3 á 4 uur blijven staan',
          step5:'Ondertussen kook je de spaghetti al dente',
          step6:'Voeg er op het laatst de fijngehakte basilicum bij. Haal de pan van het vuur en doe er eventueel nog wat boter bij.',
          step7:'Giet de ragù over de spaghetti',
        },
